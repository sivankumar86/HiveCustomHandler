...
public class GenericMaxRow extends AbstractGenericUDAFResolver {

  static final Log LOG = LogFactory.getLog(GenericMaxRow.class.getName());
  ...
  public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters) throws SemanticException {
   ...
   ObjectInspector oi = TypeInfoUtils.getStandardJavaObjectInspectorFromTypeInfo(parameters[0]);
    ...
    return new GenericMaxRowEvaluator();
  }

  // @UDFType(distinctLike=true)
  public static class GenericMaxRowEvaluator extends GenericUDAFEvaluator implements Serializable{
