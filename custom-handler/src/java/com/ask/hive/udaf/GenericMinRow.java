...
@Description(name = "minrow", value = "_FUNC_(expr) - Returns the maximum value of expr and values of associated columns as a struct")
public class GenericMinRow extends AbstractGenericUDAFResolver {

  static final Log LOG = LogFactory.getLog(GenericMinRow.class.getName());
  ...
  public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters) throws SemanticException {
   ...
   ObjectInspector oi = TypeInfoUtils.getStandardJavaObjectInspectorFromTypeInfo(parameters[0]);
    ...
    return new GenericMinRowEvaluator();
  }

  // @UDFType(distinctLike=true)
  public static class GenericMinRowEvaluator extends GenericUDAFEvaluator implements Serializable{

   transient ObjectInspector[] inputOIs;
   transient ObjectInspector[] outputOIs;
   transient ObjectInspector   structOI;
